...
export default function Categoria() {
  ...
  useEffect(() => {
    document.title = `${categoriaFormatada.toUpperCase()} | Nwayami Store`;
  }, [categoriaFormatada]);
  ...
  if (loading) {
    return (
      <section className="w-full bg-neutral-50 min-h-screen pt-40 flex flex-col items-center">
        ...
        <p className="text-neutral-500 font-medium">Filtrando categoria...</p>
      </section>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-xl">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-neutral-800 tracking-tight capitalize">
              {categoriaFormatada}
            </h1>
          </div>
        ...
        {produtosFiltrados.length === 0 ? (
          <div className="bg-white rounded-3xl p-20 text-center border border-dashed border-neutral-300">
             <div className="w-16 h-16 bg-neutral-50 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-search text-neutral-300 text-xl"></i>
             </div>
            <h2 className="text-lg font-bold text-neutral-700">Nenhum item encontrado</h2>
            <p className="text-neutral-500 text-sm mt-1">Não encontramos produtos para esta busca nesta categoria.</p>
            <Link to="/produtos" className="mt-6 inline-block text-blue-900 font-bold text-xs uppercase tracking-widest border-b-2 border-blue-900/20 pb-1">
