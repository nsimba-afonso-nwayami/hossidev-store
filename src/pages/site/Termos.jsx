...
export default function Termos() {
  return (
    <>
      <title>Termos & Condições | Hossidev Store</title>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-neutral-200 text-neutral-700 space-y-6 text-sm leading-relaxed">
            <p>
              ...
              , NIF: 5002911396, com sede em Luanda, Benfica Zona verde 3. Ao utilizar o site
               <strong className="text-blue-900 font-bold"> lojaonline.hossidev.com</strong>, o Cliente concorda com os
            ...
            <p>
              ...
              <strong className="text-blue-900"> lojaonline.hossidev.com</strong>, incluindo a venda de
